...
const headerContent: string = `<h1 class="ngde ngde" id="text" href="components/text" headinglink="true">Text<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="text"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-3rhx8jwp',
