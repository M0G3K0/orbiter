...
{{ NgDocActions.playground("TextPlayground") }}

---

## API Reference

{{ NgDocApi.api("projects/ui/src/lib/orb-text/orb-text.ts#TextComponent") }}

---

## Details

{{ NgDocApi.details("projects/ui/src/lib/orb-text/orb-text.ts#TextComponent") }}
