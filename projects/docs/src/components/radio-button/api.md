...
{{ NgDocApi.api("projects/ui/src/lib/orb-radio-button/orb-radio-button.ts#PtRadioButtonComponent") }}

---

## Details

{{ NgDocApi.details("projects/ui/src/lib/orb-radio-button/orb-radio-button.ts#PtRadioButtonComponent") }}
