...
class ButtonComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: ButtonComponent, isStandalone: true, selector: "orb-button", inputs: { variant: "variant", size: "size", disabled: "disabled" }, outputs: { buttonClick: "buttonClick" }, ngImport: i0, template: `
    <button
      [class]="buttonClasses"
      [disabled]="disabled"
...
class CardComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: CardComponent, isStandalone: true, selector: "orb-card", inputs: { size: "size", elevation: "elevation" }, ngImport: i0, template: `
...
class CardHeaderComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: CardHeaderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: CardHeaderComponent, isStandalone: true, selector: "orb-card-header", ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, styles: [":host{display:block;padding:var(--orb-card-section-padding);border-bottom:1px solid var(--orb-card-section-separator)}\n"] });
}
...
class CardContentComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: CardContentComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: CardContentComponent, isStandalone: true, selector: "orb-card-content", ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, styles: [":host{display:block;padding:var(--orb-card-section-padding)}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: CardContentComponent, decorators: [{
            type: Component,
...
class CardFooterComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: CardFooterComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: CardFooterComponent, isStandalone: true, selector: "orb-card-footer", ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, styles: [":host{display:flex;gap:var(--orb-card-section-gap);padding:var(--orb-card-section-padding);border-top:1px solid var(--orb-card-section-separator);justify-content:flex-end}\n"] });
}
